...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA0     ------> TIM2_CH1
    */
    GPIO_InitStruct.Pin = SERVO2_M_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(SERVO2_M_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PA4     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = SERVO1_M_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(SERVO1_M_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM16_MspPostInit 0 */
    ...
    PA6     ------> TIM16_CH1
    */
    GPIO_InitStruct.Pin = NEO2_M_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM16;
    HAL_GPIO_Init(NEO2_M_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM17_MspPostInit 0 */
    ...
    PA7     ------> TIM17_CH1
    */
    GPIO_InitStruct.Pin = NEO1_M_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM17;
    HAL_GPIO_Init(NEO1_M_GPIO_Port, &GPIO_InitStruct);
