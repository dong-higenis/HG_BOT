...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.text_device_info.setLineWrapMode(QPlainTextEdit.LineWrapMode.NoWrap)
        ...
        self.combo_file.setEnabled(True)
        ...
        self.btn_down_stop.setEnabled(True)
        ...
        self.prog_bar_down.setEnabled(True)
        ...
        self.menubar.setGeometry(QRect(0, 0, 1650, 33))
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"MASTER-GUI", None))
