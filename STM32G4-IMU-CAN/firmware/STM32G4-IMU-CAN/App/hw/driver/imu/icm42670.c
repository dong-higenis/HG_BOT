...
bool icm42670InitRegs(void)
{
  ...
  //	기울기 보정을 위한 값 변경 전 정보
  //	ODR 400HZ
  //	LPF 53HZ

  // GYRO
  //
  data  = ICM42670_GYRO_RANGE_250DPS << ICM42670_GYRO_UI_FS_SEL_SHIFT;
  data |= ICM42670_GYRO_ODR_12_5HZ     << ICM42670_GYRO_ODR_SHIFT;
  regWriteByte(ICM42670_REG_GYRO_CONFIG0, data);

  data = ICM42670_GYRO_LFP_16HZ << ICM42670_GYRO_UI_FILT_BW_SHIFT;
  regWriteByte(ICM42670_REG_GYRO_CONFIG1, data);

  // ACCEL
  //
  data  = ICM42670_ACCEL_RANGE_2G  << ICM42670_ACCEL_UI_FS_SEL_SHIFT;
  data |= ICM42670_ACCEL_ODR_12_5HZ << ICM42670_ACCEL_ODR_SHIFT;
  regWriteByte(ICM42670_REG_ACCEL_CONFIG0, data);

  data  = ICM42670_ACCEL_AVG_2X   << ICM42670_ACCEL_UI_AVG_SHIFT;
  data |= ICM42670_ACCEL_LFP_16HZ << ICM42670_ACCEL_UI_FILT_BW_SHIFT;
