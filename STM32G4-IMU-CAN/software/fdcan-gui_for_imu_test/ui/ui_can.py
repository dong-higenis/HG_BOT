...
class Ui_CAN(object):
    def setupUi(self, CAN):
        ...
        self.table_can_tx.setMinimumSize(QSize(500, 0))
        self.table_can_tx.setMaximumSize(QSize(16777215, 16777215))
        self.table_can_tx.setAlternatingRowColors(True)
        self.table_can_tx.setSelectionMode(QAbstractItemView.SelectionMode.NoSelection)
        self.table_can_tx.setSelectionBehavior(QAbstractItemView.SelectionBehavior.SelectItems)
        ...
        self.gridLayout.addWidget(self.table_can_tx, 1, 0, 1, 1)
